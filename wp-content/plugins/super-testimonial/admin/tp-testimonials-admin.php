<?php
	...
	function tps_super_testimonials_init() 
	{
		...
		$labels = array(
			...
			'add_new_item' => __('Add Testimonial', 'ktsttestimonial'),
	...
	function tps_super_testimonials_meta_box() {
		add_meta_box(
			'custom_meta_box', // $id
			'Super Testimonials Information - <a target="_blank" style="color:red;font-weight:bold" href="http://themepoints.com/product/super-testimonial-pro/">Unlock All Features</a>', // $title
