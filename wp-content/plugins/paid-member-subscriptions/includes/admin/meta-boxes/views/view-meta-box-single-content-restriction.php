    ...
    <div class="pms-meta-box-field-wrapper">
        ...
        <?php endforeach; ?>
            <p class="description" style="margin-top: 10px;">
                <?php echo __( 'Checking only "Logged In Users" will show this post to all logged in users, regardless of subscription plan.', 'paid-member-subscriptions' ); ?>
            </p>
            <p class="description">
                <?php echo __( 'Checking any subscription plan will show this post only to users that are subscribed those particular plans.', 'paid-member-subscriptions' ); ?>
            </p>
        <?php endif; ?>
...
<div id="pms-meta-box-fields-wrapper-restriction-redirect-url" class="pms-meta-box-fields-wrapper <?php echo ( $content_restrict_type == 'redirect' ? 'pms-enabled' : '' ); ?>">
    ...
    <div class="pms-meta-box-field-wrapper">
        ...
        <label class="pms-meta-box-checkbox-label" for="pms-content-restrict-custom-redirect-url-enabled">
            ...
            <span class="description"><?php _e( 'Check if you wish to add a custom redirect URL for this post.', 'paid-member-subscriptions' ); ?></span>
        </label>
    </div>
    ...
    <div class="pms-meta-box-field-wrapper pms-meta-box-field-wrapper-custom-redirect-url <?php echo ( ! empty( $custom_redirect_url_enabled ) ? 'pms-enabled' : '' ); ?>">
        ...
        <label class="pms-meta-box-checkbox-label">
            ...
            <p class="description"><?php _e( 'Add a URL where you wish to redirect users that do not have access to this post and try to access it directly.', 'paid-member-subscriptions' ); ?></p>
        </label>
...
<div class="pms-meta-box-fields-wrapper">
    ...
    <div class="pms-meta-box-field-wrapper">
        ...
        <label class="pms-meta-box-checkbox-label" for="pms-content-restrict-messages-enabled">
            ...
            <span class="description"><?php _e( 'Check if you wish to add custom messages for this post.', 'paid-member-subscriptions' ); ?></span>
        </label>
    </div>
