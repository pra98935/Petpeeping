...
Tags: buddypress, customization, profile tabs, add profile tab, tabs, admin bar, custom profile menu, custom tabs, custom menu, buddypress integration, profile tab reordering
...
If you like this plugin but would like to visually reorder the tabs, or get more features such as sub-tabs, public tabs, iframe tabs, or rearrange or hide default BuddyPress tabs, make sure to grab yourself a copy of the <strong>Pro</strong> version from <a href="http://sensibleplugins.com" target="_blank"><strong>Sensible Plugins</strong></a>.
